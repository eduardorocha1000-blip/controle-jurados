...
-- Execute cada comando separadamente no Console do D1
-- OU use o Wrangler CLI: wrangler d1 execute controle-jurados-db --file=./cloudflare-pages/schema-d1.sql
...
-- 10. Tabela de notificações de email
